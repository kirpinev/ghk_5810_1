...
export const App = () => {
  ...
  const submit = () => {
    ...
    window.gtag("event", "ios_jackpot_july_engage_var5");
    setLoading(true);
    sendDataToGA({
      ...
      <>
        ...
        <div className={appSt.bottomBtn}>
          <ButtonMobile
            ...
            view="secondary"
            onClick={() => {
              window.gtag("event", "ios_jackpot_july_combination_var5");
    ...
    <>
      <div className={appSt.container}>
        ...
        <Typography.Text view="primary-medium">
          Миллионы рублей - мечта или реальность?
        </Typography.Text>
        <Typography.Text view="primary-medium">
          Испытайте свою удачу, выбирайте счастливую комбинацию чисел и
          исполняйте самые заветные желания.
        </Typography.Text>
        ...
        <div className={appSt.row}>
          ...
          <Typography.Text view="primary-medium">
            Больше билетов — больше шансов к приумножению накоплений
          </Typography.Text>
        </div>
      </div>
      <Gap size={96} />
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag("event", "ios_jackpot_july_luck_var5");
            setStep("numbers");
          }}
        >
          <Typography.TitleResponsive
